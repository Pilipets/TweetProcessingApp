...
def send_sentiment_counter(df, epoch_id, api):
	...
	sentiment_json = {'positive':pos/total, 'neutral':neutral/total, 'negative':neg/total, 'total':total}
...
def get_sentiment_counter(df):
	...
	get_sentiment_udf = F.udf(get_sentiment, T.ArrayType(T.IntegerType(), False))
...
def main():
	...
	# TODO: Add ML to filter tweets by semantic
